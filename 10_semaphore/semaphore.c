...
struct gpioled_dev 
{
    ...
    struct semaphore semaphore;     /* Semaphore Structure             */
};
...
static int led_open(struct inode *inode, struct file *filp)
{
    ...
    down(&gpioled.semaphore);       /* Semaphore Take                 */
...
static int led_release(struct inode *inode, struct file *filp)
{
    ...
    up(&dev -> semaphore);          /* Semaphore Give                 */
...
static int __init gpioled_init(void)
{
    ...
    /* Semaphore Initial */
    sema_init(&gpioled.semaphore, 1);       //* Set Semaphore num as 1 */ 
